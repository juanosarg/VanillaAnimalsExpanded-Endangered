...
namespace VanillaAnimalsExpandedEndangered
{
	public class IncidentWorker_ExtintAnimalsPasses : IncidentWorker
	{
		...
		protected override bool TryExecuteWorker(IncidentParms parms)
		{
			...
			SendStandardLetter("VAEE.LetterLabelExtintAnimalsPasses".Translate(animal.label).CapitalizeFirst(), "VAEE.LetterExtintAnimalsPassesRepopulate".Translate(animal.label), 
